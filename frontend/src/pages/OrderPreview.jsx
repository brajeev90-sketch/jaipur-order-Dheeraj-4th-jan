  ...
  return (
    <div className="h-full flex flex-col" style={{ fontFamily: 'Manrope, sans-serif', fontSize: '12px' }}>
      ...
      <div className="flex gap-3 py-2">
        {/* Product Image - 75% width - LARGER (70% height increase) */}
        <div className="w-3/4">
          {productImage ? (
            <div className="border border-[#ddd] rounded p-2 bg-white flex items-center justify-center min-h-[374px]">
              <img 
                src={productImage} 
            ...
            <div className="w-full h-[374px] bg-[#f8f8f8] rounded flex items-center justify-center text-[#888] border border-[#ddd]">
